...
flags.DEFINE_string('checkpoint_dir', 'checkpoint/17_attributes_' + isResampling(resampling) + '{}_'.format(N) + '{}'.format(_lambda) + "/", 'Directory where to read/write model checkpoints')
